...
export function ModalCadastro({ visible, onClose }: IOrderModal) {
        ...
        <ContainerModal>
          ...
          {pesquisa ? (
            <div className="div2Modal">
              <p>SELECIONE UM PACIENTE JÁ CADASTRADO</p>
              <HomeInput>
                <Input
              ...
              <section>
                <p>OU CADASTRE UM NOVO PACIENTE</p>
                <button onClick={cadastroPaciente}>+ novo paciente</button>
              </section>
              ...
              <aside>
                ...
                <button className="confirm">Confirmar agendamento</button>
              </aside>
            </div>
          ) : (
            <ModalRegistro>
